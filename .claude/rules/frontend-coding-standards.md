---
paths: ["**/*.ts", "**/*.html", "**/*.scss"]
description: Angular and React coding standards - TypeScript strict mode, ESLint + Prettier, Signals, component patterns, naming conventions. Auto-loaded for TS/HTML/SCSS files.
---
